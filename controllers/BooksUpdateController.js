...
(function() {
	...
	.controller('BooksUpdateController', ['$scope', '$http', '$stateParams', '$location' , function($scope, $http, $stateParams, $location) {
									...
									if(response.data.success) {
										...
										$http({
											...
											if(response.data.success) {
												...
												$scope.books.published = new Date(response.data.published);
